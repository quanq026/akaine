class Config():
    ...
    LINKPLAY_AUTHENTICATION = '<SET_A_RANDOM_SHARED_VALUE>'
    ...
    '''
    USERNAME = '<SET_A_PRIVATE_ADMIN_USERNAME>'
    PASSWORD = '<SET_A_PRIVATE_ADMIN_PASSWORD>'
    '''
    --------------------
    '''
    ...
    '''
    SECRET_KEY = '<SET_A_RANDOM_SESSION_SECRET>'
    '''
    --------------------
    '''
    ...
    # Disabled by default because this compatibility route accepts a client
    # supplied OAuth value and signs every caller into one shared account.
