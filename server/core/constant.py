...
class Constant:
    ...
    ASSET_SIGNING_ENABLED = Config.ASSET_SIGNING_ENABLED
    ASSET_SIGNED_PREFIX = Config.ASSET_SIGNED_PREFIX
    ASSET_SIGNING_SECRET = Config.ASSET_SIGNING_SECRET
    ASSET_SIGNING_PROTECT_ALL_SONGS = Config.ASSET_SIGNING_PROTECT_ALL_SONGS
    ASSET_SIGNING_SONG_IDS = Config.ASSET_SIGNING_SONG_IDS
    ASSET_SIGNED_TTL_AUDIO = Config.ASSET_SIGNED_TTL_AUDIO
    ASSET_SIGNED_TTL_CHART = Config.ASSET_SIGNED_TTL_CHART
